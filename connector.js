...
class ServiceNowConnector {
  ...
  constructor(options) {
    ...
    process.stdout.write('constructor options:\n' + JSON.stringify(this.options, null, 2) + '\n');
  }
...
processRequestResults(error, response, body, callback) {
   ...
   */
   let hibernating = Boolean(this.isHibernating(response));
   let callbackError = null;
   let callbackData = null;
   //process.stdout.write('hibernating: ' + hibernating + '\n');
   if (error) {
    ...
    */
    constructUri(query = null) {
        ...
        console.log('constructUri returned: ' + uri)
        return uri;
    }
